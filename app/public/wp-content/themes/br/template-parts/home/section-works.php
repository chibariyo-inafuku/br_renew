...
$q = br_query_portfolio_for_list_term_limited( 'works-s', 8 );
...
?>
<section class="br-home__section br-home__section--works br-home__works">
	<div class="br-container">
		<header class="br-home__section-head br-home__section-head--split">
			<h2 class="br-home__section-title">
				<span class="br-home__section-title-en"><?php esc_html_e( 'Works', 'br' ); ?></span>
				<span class="br-home__section-title-jp"><?php esc_html_e( '/ 実績紹介', 'br' ); ?></span>
			</h2>
			<?php if ( $more !== '' ) : ?>
