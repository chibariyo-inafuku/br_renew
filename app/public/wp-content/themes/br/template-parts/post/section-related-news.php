<?php
/**
 * News single: related posts carousel (reads `$GLOBALS['br_section_related_news_query']` from single-post.php).
 *
 * @package br
 */
...
$query = null;
if ( isset( $GLOBALS['br_section_related_news_query'] ) && $GLOBALS['br_section_related_news_query'] instanceof WP_Query ) {
	$query = $GLOBALS['br_section_related_news_query'];
}
...
?>
<section class="br-portfolio-related" data-br-subpage-reveal aria-labelledby="br-news-related-heading">
	<div class="br-container">
		<header class="br-portfolio-related__head br-portfolio-related__head--with-nav">
			<div class="br-portfolio-related__head-text br-home__works-heading br-home__section-head">
				<h2 class="br-home__works-title" id="br-news-related-heading">
		...
		<div class="swiper br-portfolio-related__swiper">
			<div class="swiper-wrapper">
				...
				while ( $query->have_posts() ) :
					$query->the_post();
					$card_id   = get_the_ID();
					$badge     = function_exists( 'br_get_news_post_card_category_label' ) ? br_get_news_post_card_category_label( $card_id ) : '';
