<?php
/**
 * Service single: related posts carousel (reads `$GLOBALS['br_section_related_service_query']` from single-post.php).
 *
 * @package br
 */
...
$query = null;
if ( isset( $GLOBALS['br_section_related_service_query'] ) && $GLOBALS['br_section_related_service_query'] instanceof WP_Query ) {
	$query = $GLOBALS['br_section_related_service_query'];
}
...
?>
<section class="br-portfolio-related" data-br-subpage-reveal aria-labelledby="br-service-other-heading">
	<div class="br-container">
		<header class="br-portfolio-related__head br-portfolio-related__head--with-nav">
			<div class="br-portfolio-related__head-text br-home__works-heading br-home__section-head">
				<h2 class="br-home__works-title" id="br-service-other-heading">
					<span class="screen-reader-text">Other Service / その他のサービス</span>
					<div class="br-svg-heading br-svg-heading--on-light" data-br-svg-heading>
						<svg
							...
							focusable="false"
						>
							<text class="br-svg-heading__text" x="0" y="86" font-weight="700">Other Service</text>
						</svg>
						<div class="br-svg-heading__sub-wrap">
							<span class="br-home__works-title-jp br-svg-heading__sub">/ その他のサービス</span>
						</div>
					</div>
				</h2>
			</div>
			<div class="br-portfolio-related__head-right">
				<div class="br-portfolio-related__rail-nav" role="group" aria-label="その他のサービスのスライド">
		...
		<div class="swiper br-portfolio-related__swiper">
			<div class="swiper-wrapper">
				...
				while ( $query->have_posts() ) :
					$query->the_post();
					$card_id = get_the_ID();
					$badge   = function_exists( 'br_get_service_post_card_category_label' ) ? br_get_service_post_card_category_label( $card_id ) : '';
					?>
